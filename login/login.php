...
<div class="col-md-6 mhide" data-color="blue" style="background:url(back.jpg);height:100%;">
<center> <br><br><br><br><br><br><br><br><br><br><br><br>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
											...
											<input type='submit' value='Sign In' name='login' class='form-control btn-success' style="background:#f15e61;color:#fff;">
